...
//GxEPD2_3C<GxEPD2_154_Z90c, GxEPD2_154_Z90c::HEIGHT> display(GxEPD2_154_Z90c(/*CS=*/ 7, /*DC=*/ 6, /*RST=*/ 10, /*BUSY=*/ 11));

void elink_1_54_init()
{
    Serial.println("enter elink_1_54_init");
...
{
    drawBitmapFromSpiffs("wifi3.bmp", 10, 0, 0);
    drawBitmapFromSpiffs("long.bmp", 34, 12, 0);
    drawBitmapFromSpiffs("bb4.bmp", 118, 5, 0);
}
